...
/**
 *  \defgroup   fusioncc     FusionCC
 *  \brief      Fusionner les comptes comptables.
 *  \file       htdocs/custom/fusioncc/core/modFusionCC.class.php
 *  \ingroup    Fusioncc
 *  \brief      Fichier de description et activation du module FusionCC
 */
 ...
 */
class modFusionCC extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 300305;     // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'fusioncc';
        ...
        $this->description = "Fusion et suppression des comptes comptables";
        $this->descriptionlong = "Recherche les numéros de comptes comptables en doublons, les fusionnent et supprime les doublons inutiles.";
        ...
        $this->depends = array('modProgiseize');       // List of module class names as string that must be enabled if this module is enabled
        ...
        $this->langfiles = array("fusioncc@fusioncc");
        ...
        */
        ...
        $this->rights[$r][1] = 'Fusionner';    // Permission label
        $this->rights[$r][3] = 0;                    // Permission by default for new user (0/1)
        $this->rights[$r][4] = 'fusionner';             // In php code, permission will be checked by test
        ...
        $this->menu[$r]=array(
            ...
            'type'=>'left',
            'titre'=>'Fusion des comptes comptables',
            'mainmenu'=>'',
            'leftmenu'=>'',
            'url'=>'/fusioncc/index.php',
            'langs'=>'fusioncc@fusioncc',
        ...
        $this->menu[$r]=array(
            'fk_menu'=>'fk_mainmenu=accountancy,fk_leftmenu=accountancy_admin',
            'type'=>'left',
            'titre'=>'Fusion des comptes comptables',
            'mainmenu'=>'',
            'leftmenu'=>'',
